...
import {IBoardWriteUIPorps} from './BoardWrite.types'
import * as S from './BoardWrite.styles'
//  위의 import식에서 {}안에 많은 변수를 담기 힘들때 한꺼번에 가져올 때 쓸 수 있는 코드



// 등록하기 페이지 HTML
export default function BoardWriteUI(props: IBoardWriteUIPorps){
    console.log(props.data)
// HTML
    return(
    <>
        {/* isEdit뒤에 ?는 삼항연상자, data 뒤에 ?는 옵셔널체이닝 */}
